...
class ProducersController < ApplicationController
  def index
    ...
    producers_data.each do |producer|
      ...
      producer['nav_link'] = "https://www.google.com/maps/dir/?api=1&origin=#{latitude},#{longitude}&destination=#{producer["adressesOperateurs"][0]["lat"]},#{producer["adressesOperateurs"][0]["long"]}&travelmode=driving"
